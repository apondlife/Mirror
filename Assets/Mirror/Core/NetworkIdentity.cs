        ...
        void AssignSceneID()
        {
            ...
            if (sceneId == 0 || duplicate)
            {
                ...
                if (BuildPipeline.isBuildingPlayer)
                    throw new BuildFailedException($"Scene {gameObject.scene.path} needs to be opened and resaved before building, because the scene object {name} has no valid sceneId yet.");
